...
from config import NEO4J_ENABLED, TWITTER_ENABLED, LINKEDIN_ENABLED, VIRUSTOTAL_ENABLED, ABUSEIPDB_ENABLED
...
if __name__ == '__main__':
    ...
    print(f"  LinkedIn:  {'Enabled' if LINKEDIN_ENABLED else 'Disabled (set GOOGLE_CSE_API_KEY & GOOGLE_CSE_ID in .env)'}")
